...
# ggExtra removed: removeGrid() replaced with theme(panel.grid = element_blank())
# Loading ggExtra pulls in shiny/S7 deps that conflict with ggplot2 4.x +.gg dispatch
library(tidyr) 
library(tibble)
...
p <- p + theme(legend.position = "bottom") +
  ...
  theme(panel.grid = element_blank()) # replaces ggExtra::removeGrid() (incompatible with ggplot2 4.x S7)
